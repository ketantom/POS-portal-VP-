        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 bg-white text-gray-400 font-bold text-xs uppercase tracking-wider">Or continue with</span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 px-4 rounded-xl bg-white hover:bg-gray-50 text-gray-700 font-bold transition-all border border-gray-200 shadow-sm flex items-center justify-center gap-3 disabled:opacity-50"
          >
